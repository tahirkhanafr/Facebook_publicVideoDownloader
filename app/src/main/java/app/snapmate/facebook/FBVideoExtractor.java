...
public abstract class FBVideoExtractor  extends AsyncTask<Void,Integer, FacebookFile> {
...
//                int maxLogSize = 1000;
//                for(int i = 0; i <= streamMap.length() / maxLogSize; i++) {
//                    int start = i * maxLogSize;
//                    int end = (i+1) * maxLogSize;
//                    end = Math.min(end, streamMap.length());
//                    Log.e("Facebook Out ", streamMap.substring(start, end));
//
//                }
...
//                Pattern metaTAGVIdeoLink = Pattern.compile("<meta property=\"og:description\"(.+?)\" />");
//                Matcher metaTAGVideoLinkMatcher = metaTAGVIdeoLink.matcher(streamMap);
//
...
//                    Log.e("Extractor","FILENAME :: "+name);
    ...
    public FBVideoExtractor(Context context, String url,boolean showLogs) {
